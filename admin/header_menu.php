...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
  <div class="container">
    <a href="products.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">OpenKart</a>
      ...
      <ul class="nav navbar-nav">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a href="watch.php" class="dropdown-item">Watches</a>
            <a href="shirts.php" class="dropdown-item">T-Shirts</a>
            <a href="shoes.php" class="dropdown-item">Shoes</a>
            <a href="speakers.php" class="dropdown-item">Headphones/Speakers</a>
          </div>
